...
namespace Avalonia.Win32
{
        ...
        ITopLevelImplWithTextInputMethod
    {
        ...
        public IRenderer CreateRenderer(IRenderRoot root)
        {
            ...
            return _isUsingComposition ? new DeferredRenderer(root, loop) { RenderOnlyOnRenderThread = true } : (IRenderer)new DeferredRenderer(root, loop, rendererLock: _rendererLock);
        }
