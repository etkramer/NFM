...
namespace Avalonia.Win32.Interop
{
    ...
    public unsafe static class UnmanagedMethods
    {
        ...
        internal static extern int Shell_NotifyIcon(NIM dwMessage, NOTIFYICONDATA lpData);
        ...
        internal static extern int OleGetClipboard(out IOleDataObject dataObject);

        [DllImport("ole32.dll", PreserveSig = true)]
        internal static extern int OleSetClipboard(IOleDataObject dataObject);
        ...
        [DllImport("gdi32.dll")]
        internal static extern int DescribePixelFormat(IntPtr hdc, ref PixelFormatDescriptor pfd);

        [DllImport("gdi32.dll")]
        internal static extern int SetPixelFormat(IntPtr hdc, int iPixelFormat, ref PixelFormatDescriptor pfd);

        [DllImport("gdi32.dll")]
        internal static extern int DescribePixelFormat(IntPtr hdc, int iPixelFormat, int bytes, ref PixelFormatDescriptor pfd);
        ...
        [DllImport("imm32.dll")]
        internal static extern bool ImmSetCandidateWindow(IntPtr hIMC, ref CANDIDATEFORM lpCandidate);
        [DllImport("imm32.dll")]
        internal static extern bool ImmSetCompositionWindow(IntPtr hIMC, ref COMPOSITIONFORM lpComp);
        [DllImport("imm32.dll")]
