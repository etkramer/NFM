...
public class VisibilityStep : CameraStep<VisibilityRenderPipeline>
{
	...
	public override void Init()
	{
		...
		visPSO = new PipelineState()
			...
			.SetPixelShader(Embed.GetString("Shaders/Visibility/VisibilityPS.hlsl", typeof(Engine).Assembly), "VisibilityPS")
			.AsRootConstant(0, 1)
