...
{
	public class NumInputLegacy : UserControl
	{
		public NumInputLegacy(IEnumerable<object> subjects, PropertyInfo property)
		...
		public NumInputLegacy(Func<object> getter, Action<object> setter, bool hasMultipleValues, char iconOverride = '\uE3C9')
		{
